...
class CashierLoginActivity : AppCompatActivity() {
                    ...
                    if (loginTask.isSuccessful) {
                        ...
                        if (user != null) {
                            if (user.isEmailVerified) {
                                ...
                                val userId = user.uid
                                database.child("CashierTbl").child(userId).get()
                                    .addOnSuccessListener { dataSnapshot ->
                                        ...
                                        if (userData != null && userData.user_type != "Guest") {
                                            ...
                                            ProgressBar.visibility = View.GONE
                                            Toast.makeText(this, "Guest users are not allowed to login.", Toast.LENGTH_SHORT).show()
